...
public class NewsEventRegister extends BaseTemplate{
	...
	public MData onExecute(MData param) throws MException {
		try {
			return MResponseUtil.toMData(newsEventService.registerNewsEvent(param)
					, "newsEventID","categoryCode","contentDesc","statusCode");
		} catch (MException e) {
			throw e;
		} catch (Exception e){
			throw new MBizException(CommonErrorCode.UNCAUGHT.getCode(), CommonErrorCode.UNCAUGHT.getDescription());
