...
public class AdminUriAccessConst {
	...
	public static final String	CLASS_LIST_STUDENT		= "/api/class-info/list/student";
	public static final String	CLASS_REGISTER			= "/api/class-info/register";
	public static final String	CLASS_REGISTER_STUDENT	= "/api/class-info/register/student";
	public static final String	CLASS_UDPATE			= "/api/class-info/update";
	public static final String	CLASS_UPGRADE			= "/api/class-info/upgrade";
	public static final String	CLASS_UPDATE_STUDENT	= "/api/class-info/update/student";
	
	public static final String	SUBJECT_LIST			= "/api/subject/list";
	public static final String	SUBJECT_DOWNLOAD		= "/api/subject/list/download";
	public static final String	SUBJECT_REGISTER		= "/api/subject/register";
	public static final String	SUBJECT_UDPATE			= "/api/subject/update";
	
	public static final String	SCORE_LIST				= "/api/score/list";
	public static final String	SCORE_REGISER			= "/api/score/register";
	
	public static final String	ROOM_LIST				= "/api/room/list";
	public static final String	ROOM_DOWNLOAD			= "/api/room/list/download";
	public static final String	ROOM_REGISTER			= "/api/room/register";
	public static final String	ROOM_UDPATE				= "/api/room/update";
